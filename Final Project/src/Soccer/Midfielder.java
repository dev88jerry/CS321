 ...
 * Name: Jerry Lau
 * Date: 28 Apr 2022
 * Description: Midfielder class that extends player
 */
...
/**
 * A specific type of player with relatively equal attributes
 */
public class Midfielder extends Player{
    ...
    /**
     * Midfielder constructor and sets the position
     * Generates a random name for the object
     * @param pos char of position
     */
    public Midfielder(char pos){
        super();
        super.position = pos;
        super.name = "MID " + super.generateName();
    }

    /**
     * Method to generate midfielder stats
